Date of synchrony experiment: 2/11/15
Person carrying out experiment: Adam Leman and Crystal Sierra
Lab Notebook: Joint Pathogenic Notebook

Strain: H99 (W or E?); Crystal received on 12-3-2012 from the Heitman lab (other notation ÒPF001Ó)

STARTING CONDITIONS
Starting media: YEP 2% dextrose
Starting culture: 1.5L in plastic fernbach flask
Temperature of waterbath: 30 deg Celsius
Starting concentration: 3.6e7 cells/ml
...
Starting culture: 269 ml in Large Glass Flask
Temperature of waterbath: 30 deg Celsius
Waterbath used: Temperature-controlled incubator(#4), 125 RPM (note: internal temperature set to 27.2*C, external temperature register at 30.0*C)

Frequency of time points: every 10 minutes
Length of time course following synchronization: 200 minutes
